...
function isChecked() {
  return getRandomInteger(0, 1) ? 'checked' : '';
}
...
export function createFormTemplate(point, pointDestination, pointOffers, arrayDestinationsModel){
 ...
 <header class="event__header">
   ...
   <div class="event__field-group  event__field-group--destination">
     ...
     <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" placeholder="Chamonix" value="" list="destination-list-1">
